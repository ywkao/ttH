...
if [ "$CMSSW_VER" = "105X" ]; then
  ...
  #INPUTFILENAMES='file:/home/users/sjmay/ttH/BabyMaker/CMSSW_10_5_0/src/flashgg/microAOD_ttHJetToGG_M125_2018.root'
  cmsRun Taggers/test/ttH_TagAndDump.py ${INPUTFILENAMES} "MetaData/data/MetaConditions/Era2016_RR-17Jul2018_v1.json" "1000"
fi
