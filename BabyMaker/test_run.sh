...
if [ "$CMSSW_VER" = "102X" ]; then
  ...
  cmsRun Taggers/test/ttH_TagAndDump.py ${INPUTFILENAMES} "MetaData/data/MetaConditions/Era2017_RR-31Mar2018_v1.json"
fi
...
if [ "$CMSSW_VER" = "105X" ]; then
  ...
  #INPUTFILENAMES='file:/hadoop/cms/store/user/smay/ttH/MicroAOD/RunII/TTGG_0Jets_TuneCP5_13TeV_amcatnlo_madspin_pythia8_RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v2_MINIAODSIM_RunII/test_skim_1.root'
  #INPUTFILENAMES='file:/hadoop/cms/store/user/smay/ttH/MicroAOD/RunII/DiPhotonJetsBox_MGG-80toInf_13TeV-Sherpa_RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v2_MINIAODSIM_RunII/test_skim_1.root'
  #INPUTFILENAMES='file:/hadoop/cms/store/user/smay/ttH/MicroAOD/RunII/GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8_RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v2_MINIAODSIM_RunII/test_skim_2.root'
  #INPUTFILENAMES='file:/hadoop/cms/store/user/smay/ttH/MicroAOD/RunII/ttHToGG_M125_13TeV_powheg_pythia8_RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1_MINIAODSIM_RunII/test_skim_1.root'
  INPUTFILENAMES='file:/hadoop/cms/store/user/smay/ttH/MicroAOD/RunII/ttHToGG_M125_13TeV_powheg_pythia8_RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1_MINIAODSIM_RunII/test_skim_2.root'
