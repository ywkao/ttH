...
// makeCMS3ClassFiles("/hadoop/cms/store/user/hmei/tmp/TTGJets_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8__ttH_Babies_overlapRemove_2017/merged_ntuple_1.root", "tthLeptonicTagDumper/trees/tth_13TeV_all", "ttHLeptonic", "tas", "cms3")
