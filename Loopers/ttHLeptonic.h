...
// makeCMS3ClassFiles("/hadoop/cms/store/user/smay/ttH/DoubleEG__ttH_Babies_v3.11_2017/merged_ntuple_1.root", "tthLeptonicTagDumper/trees/tth_13TeV_all", "ttHLeptonic", "tas", "cms3")
