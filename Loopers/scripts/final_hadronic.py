...
if do_diphoton_fits:
    ...
    os.chdir("Plots")
    for plot_type in plot_types:
        parallel_utils.run('python plot_wrapper.py --input_file "../ttHHadronic_RunII_MVA_Presel_%s_histogramsRunII.root" --backgrounds "DiPhoton|QCD_GammaJets_imputed|TTGG|TTGJets|TTJets" --signals "ttH" --plot_type "%s" --plot_labels "ttH Hadronic|Loose MVA Presel.|Pre-Fit"' % (args.tag + "_impute_no_scale", plot_type))
        parallel_utils.run('python plot_wrapper.py --input_file "../ttHHadronic_RunII_MVA_Presel_%s_histogramsRunII.root" --backgrounds "DiPhoton|GammaJets|QCD|TTGG|TTGJets|TTJets" --signals "ttH" --plot_type "%s" --plot_labels "ttH Hadronic|Loose MVA Presel.|Pre-Fit"' % (args.tag + "_no_scale", plot_type))
...
if do_imputing:
    ...
    os.chdir("Plots")
    for plot_type in plot_types:
        parallel_utils.run('python plot_wrapper.py --input_file "../ttHHadronic_RunII_MVA_Presel_%s_histogramsRunII.root" --backgrounds "DiPhoton|QCD_GammaJets_imputed|TTGG|TTGJets|TTJets" --signals "ttH" --plot_type "%s" --plot_labels "ttH Hadronic|Loose MVA Presel.|Post-Fit"' % (args.tag + "_impute", plot_type))
    ...
    os.chdir("Plots")
    for plot_type in plot_types:
        parallel_utils.run('python plot_wrapper.py --input_file "../ttHHadronic_RunII_MVA_Presel_%s_histogramsRunII.root" --backgrounds "DiPhoton|GammaJets|QCD|TTGG|TTGJets|TTJets" --signals "ttH" --plot_type "%s" --plot_labels "ttH Hadronic|Loose MVA Presel.|Post-Fit"' % (args.tag + "_scale_diphoton", plot_type))
    os.chdir("../")
...
if do_mvas:
    ...
    #parallel_utils.run('python make_za_comparisons.py --inputs "za_Hadronic___%s_RunII_MVA_Presel_scale_diphoton.npz,za_Hadronic__%s_RunII_MVA_Presel_impute.npz" --labels "MC Description,Data-driven Description"' % (args.tag, args.tag))
...
if do_dnns:
    ...
    #parallel_utils.run('python train_dnn.py --input "ttHHadronic_%s_RunII_MVA_Presel_impute_dnn_features_dipho.hdf5" --tag "ttHHadronic_ttH_vs_dipho_%s" --channel "Hadronic" --preprocess_scheme "preprocess_scheme_Hadronic_dipho.json"' % (args.tag, args.tag), False)
    #parallel_utils.run('python train_dnn.py --input "ttHHadronic_%s_RunII_MVA_Presel_impute_dnn_features_ttGG.hdf5" --tag "ttHHadronic_ttH_vs_ttGG_%s" --channel "Hadronic" --preprocess_scheme "preprocess_scheme_Hadronic_ttGG.json"' % (args.tag, args.tag), False)
