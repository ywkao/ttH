...
if do_dnns:
    ...
    command_list = []
    #command_list.append('python prep_dnn.py --input "../Loopers/MVABaby_ttHLeptonic_%s_FCNC.root" --channel "Leptonic" --fcnc --z_score --signal "FCNC_hut" --backgrounds "ttH" --tag "hut_FCNC_vs_SMHiggs"' % (args.tag))
    ...
    command_list.append('python prep_dnn.py --input "../Loopers/MVABaby_ttHHadronic_%s_impute_FCNC.root" --channel "Hadronic" --fcnc --z_score --signal "FCNC_hut" --backgrounds "ttH" --tag "hut_FCNC_vs_SMHiggs" --add_mass_constraints' % (args.tag))
    command_list.append('python prep.py --input "../Loopers/MVABaby_ttHHadronic_%s_impute_FCNC.root" --channel "Hadronic" --fcnc_hut --FCNC_vs_SMHiggs --tag "_hut_FCNC_vs_SMHiggs"' % (args.tag))
    ...
    #parallel_utils.run('python train_dnn.py --input "ttHLeptonic_%s_FCNC_dnn_features_hut_FCNC_vs_SMHiggs.hdf5" --channel "Leptonic" --tag "%s" --preprocess_scheme "preprocess_scheme_Leptonic_hut_FCNC_vs_SMHiggs.json"' % (args.tag, args.tag + "_hut_FCNC_vs_SMHiggs"), True)
 
    parallel_utils.run('python train.py --input "ttHHadronic_%s_impute_FCNC_features_hut_FCNC_vs_SMHiggs.hdf5" --channel "Hadronic" --tag "%s" --ext ""' % (args.tag, args.tag + "_hut_FCNC_vs_SMHiggs"))
    parallel_utils.run('python train_dnn.py --input "ttHHadronic_%s_impute_FCNC_dnn_features_hut_FCNC_vs_SMHiggs.hdf5" --channel "Hadronic" --tag "%s" --preprocess_scheme "preprocess_scheme_Hadronic_hut_FCNC_vs_SMHiggs.json"' % (args.tag, args.tag + "_hut_FCNC_vs_SMHiggs"), True)
