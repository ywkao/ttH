...
#parallel_utils.run('python train_dnn.py --input "ttHLeptonic_%s_dnn_features_%s.hdf5" --tag "ttHLeptonic_ttH_vs_tH_%s" --channel "Leptonic" --preprocess_scheme "preprocess_scheme_%s_%s.json"' % (args.tag, args.tag, args.tag, "Leptonic", args.tag), False)
parallel_utils.submit_jobs(command_list, 4)
