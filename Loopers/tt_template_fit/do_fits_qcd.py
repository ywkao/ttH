...
for template, info in templates_dict.iteritems():
  ...
  for i in range(hists_weights[template].GetNbinsX()):
    #print(template)
    #print("Entries: %.2f" % hists_unweighted.GetBinContent(i+1))
    #print("Weighted content:  %.2f" % hists_weighted.GetBinContent(i+1))
    #print(hists_weights[template].GetBinContent(i+1))
  ...
  #if did_pp:
    #print hists["pp"][2].GetBinContent(10)
    #for i in range(hists_weights.GetNbinsX()):
    #  print hists["pp"][2].GetBinContent(i+1)


#print(hists["pp"][2].GetBinContent(9))
...
#print(hist_weights_list[2].GetBinContent(9))

h_data =  hists["data"][0]
initial_fracs = []
for i in range(len(hist_weighted_list)):
  print(i)
  print(hist_unweighted_list[i].Integral())
  print(hist_weighted_list[i].Integral())
  print(hist_weights_list[i].GetBinContent(9))
  initial_fracs.append(hist_weighted_list[i].Integral() / h_data.Integral())
...
for i in range(4):
  fit.SetWeight(i, hist_weights_list[i]) 
