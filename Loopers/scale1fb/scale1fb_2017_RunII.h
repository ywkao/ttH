double scale1fb_2017_RunII(TString currentFileTitle) {
  std::map<TString, double> m = {
        ...
        {"TT_FCNC-aTtoHJ_Tleptonic_HToaa_eta_hct-MadGraph5-pythia8", 0.0010270325},
        ...
        {"ST_FCNC-TH_Tleptonic_HToaa_eta_hct-MadGraph5-pythia8", 0.0002593743},
        ...
        {"ST_FCNC-TH_Tleptonic_HToaa_eta_hut-MadGraph5-pythia8", 0.0002508474},
