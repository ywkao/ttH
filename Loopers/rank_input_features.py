...
cats = {
  	"b_tagging" : {"features" : [vars["nb_loose"], vars["max_btag"], vars["second_max_btag"]]},
	"jet_kinematics" : { "features" : [vars["n_jets"], vars["ht"], vars["jet1_pt"], vars["jet1_eta"], vars["jet2_pt"], vars["jet2_eta"], vars["jet3_pt"], vars["jet3_eta"], vars["jet4_pt"], vars["jet4_eta"], vars["jet5_pt"], vars["jet5_eta"]]},
	"diphoton" : { "features" : [vars["helicity_angle"], vars["dR_higgs_lep"], vars["dR_higgs_W"], vars["pt_higgs"], vars["diphoton_dR"], vars["diphoton_cosine_delta_phi"], vars["diphoton_rapidity"]]},
	"individual_photon" : { "features" : [vars["lead_pt_over_m"], vars["sublead_pt_over_m"], vars["lead_eta"], vars["sublead_eta"], vars["lead_psv"], vars["sublead_psv"], vars["max_phoIDMVA"], vars["min_phoIDMVA"], vars["min_dr_lead_pho"], vars["min_dr_sublead_pho"]]},
	"lepton" : { "features" : [vars["lepton_pt"], vars["lepton_eta"], vars["mt"], vars["n_leps"]]},
}
