...
// makeCMS3ClassFiles("/home/users/hmei/ttH/Loopers/merged_babies/TTGG_0Jets_TuneCP5_13TeV_amcatnlo_madspin_pythia8__ttH_Babies_topTagger_v1.1_2017/merged_ntuple.root", "tthHadronicTagDumper/trees/tth_13TeV_all", "ttHHadronic", "tas", "cms3")
...
class ttHHadronic {
 ...
 protected: 
  ...
  float    topTag_pT_;
  TBranch *topTag_pT_branch;
  bool     topTag_pT_isLoaded;
  float    topTag_eta_;
  TBranch *topTag_eta_branch;
  bool     topTag_eta_isLoaded;
  float    topTag_phi_;
  TBranch *topTag_phi_branch;
  bool     topTag_phi_isLoaded;
...
void LoadAllBranches(); 
  ...
  const float &topTag_pT();
  const float &topTag_eta();
  const float &topTag_phi();
