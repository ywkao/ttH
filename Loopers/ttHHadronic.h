...
class ttHHadronic {
 ...
 protected: 
  ...
  float    jet1_b_DeepCSV_discriminant_;
  TBranch *jet1_b_DeepCSV_discriminant_branch;
  bool     jet1_b_DeepCSV_discriminant_isLoaded;
  float    jet2_b_DeepCSV_discriminant_;
  TBranch *jet2_b_DeepCSV_discriminant_branch;
  bool     jet2_b_DeepCSV_discriminant_isLoaded;
  float    jet3_b_DeepCSV_discriminant_;
  TBranch *jet3_b_DeepCSV_discriminant_branch;
  bool     jet3_b_DeepCSV_discriminant_isLoaded;
  float    jet4_b_DeepCSV_discriminant_;
  TBranch *jet4_b_DeepCSV_discriminant_branch;
  bool     jet4_b_DeepCSV_discriminant_isLoaded;
  float    jet5_b_DeepCSV_discriminant_;
  TBranch *jet5_b_DeepCSV_discriminant_branch;
  bool     jet5_b_DeepCSV_discriminant_isLoaded;
  float    jet6_b_DeepCSV_discriminant_;
  TBranch *jet6_b_DeepCSV_discriminant_branch;
  bool     jet6_b_DeepCSV_discriminant_isLoaded;
  float    jet7_b_DeepCSV_discriminant_;
  TBranch *jet7_b_DeepCSV_discriminant_branch;
  bool     jet7_b_DeepCSV_discriminant_isLoaded;
  float    jet8_b_DeepCSV_discriminant_;
  TBranch *jet8_b_DeepCSV_discriminant_branch;
  bool     jet8_b_DeepCSV_discriminant_isLoaded;
  float    jet9_b_DeepCSV_discriminant_;
  TBranch *jet9_b_DeepCSV_discriminant_branch;
  bool     jet9_b_DeepCSV_discriminant_isLoaded;
  float    jet10_b_DeepCSV_discriminant_;
  TBranch *jet10_b_DeepCSV_discriminant_branch;
  bool     jet10_b_DeepCSV_discriminant_isLoaded;
  float    jet11_b_DeepCSV_discriminant_;
  TBranch *jet11_b_DeepCSV_discriminant_branch;
  bool     jet11_b_DeepCSV_discriminant_isLoaded;
  float    jet12_b_DeepCSV_discriminant_;
  TBranch *jet12_b_DeepCSV_discriminant_branch;
  bool     jet12_b_DeepCSV_discriminant_isLoaded;
  float    jet13_b_DeepCSV_discriminant_;
  TBranch *jet13_b_DeepCSV_discriminant_branch;
  bool     jet13_b_DeepCSV_discriminant_isLoaded;
  float    jet14_b_DeepCSV_discriminant_;
  TBranch *jet14_b_DeepCSV_discriminant_branch;
  bool     jet14_b_DeepCSV_discriminant_isLoaded;
  float    jet15_b_DeepCSV_discriminant_;
  TBranch *jet15_b_DeepCSV_discriminant_branch;
  bool     jet15_b_DeepCSV_discriminant_isLoaded;
...
void LoadAllBranches(); 
  ...
  const float &jet1_b_DeepCSV_discriminant();
  const float &jet2_b_DeepCSV_discriminant();
  const float &jet3_b_DeepCSV_discriminant();
  const float &jet4_b_DeepCSV_discriminant();
  const float &jet5_b_DeepCSV_discriminant();
  const float &jet6_b_DeepCSV_discriminant();
  const float &jet7_b_DeepCSV_discriminant();
  const float &jet8_b_DeepCSV_discriminant();
  const float &jet9_b_DeepCSV_discriminant();
  const float &jet10_b_DeepCSV_discriminant();
  const float &jet11_b_DeepCSV_discriminant();
  const float &jet12_b_DeepCSV_discriminant();
  const float &jet13_b_DeepCSV_discriminant();
  const float &jet14_b_DeepCSV_discriminant();
  const float &jet15_b_DeepCSV_discriminant();
