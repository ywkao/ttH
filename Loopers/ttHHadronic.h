...
// makeCMS3ClassFiles("/hadoop/cms/store/user/smay/ttH/DoubleEG__ttH_Babies_v3.11_2017/merged_ntuple_1.root", "tthHadronicTagDumper/trees/tth_13TeV_all", "ttHHadronic", "tas", "cms3")
