...
do
    ...
    nbkg0=`sed -n '1p' CMS-HGG_bkg_TTHHadronicTag_0_${i}_nbkg.txt`
    nbkg1=`sed -n '1p' CMS-HGG_bkg_TTHHadronicTag_1_${i}_nbkg.txt`
...
tail final_sort.txt
#rm sig_*txt
#rm CMS-HGG_bkg_TTHHadronicTag_*_nbkg.txt
#rm mvaScore*txt
