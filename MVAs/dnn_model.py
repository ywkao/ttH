...
def baseline_v1(max_objects, n_features, n_global_features, no_global, no_lstm, n_lstm):
  ...
  #conv = keras.layers.Dropout(dropout_rate, name = 'conv_dropout_3')(conv)
  #conv = keras.layers.Convolution1D(10, 1, kernel_initializer = 'lecun_uniform', activation = 'relu', kernel_constraint = keras.constraints.maxnorm(maxnorm), name = 'conv_4')(conv)
  #conv = keras.layers.Dropout(dropout_rate, name = 'conv_dropout_4')(conv)
  ...
  # lstm
  batch_momentum = 0.6
  lstm = keras.layers.LSTM(n_lstm, dropout = 0.0, recurrent_dropout = 0.0, implementation=2, activation = 'tanh',  kernel_constraint = keras.constraints.maxnorm(maxnorm), recurrent_constraint = keras.constraints.maxnorm(maxnorm), name='lstm_1', go_backwards=False, return_sequences=True)(conv)
  #lstm = keras.layers.normalization.BatchNormalization(momentum = batch_momentum, name = "lstm_batchnorm_1")(lstm)
  #lstm = keras.layers.Dropout(dropout_rate, name = 'lstm_dropout_1')(lstm)
  lstm = keras.layers.LSTM(n_lstm, dropout = 0.0, recurrent_dropout = 0.0, implementation=2, activation = 'tanh',  kernel_constraint = keras.constraints.maxnorm(maxnorm), recurrent_constraint = keras.constraints.maxnorm(maxnorm), name='lstm_2', go_backwards=False, return_sequences=True)(lstm)
  ...
  lstm = keras.layers.LSTM(n_lstm, dropout = 0.0, recurrent_dropout = 0.0, implementation=2, activation = 'tanh',  kernel_constraint = keras.constraints.maxnorm(maxnorm), recurrent_constraint = keras.constraints.maxnorm(maxnorm), name='lstm_4', go_backwards=False)(lstm)
