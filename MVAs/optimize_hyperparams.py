...
def estimate_max_za(n_round, max_depth, eta, subsample, colsample_bytree, min_child_weight, gamma, reg_alpha, reg_lambda):
  ...
  max_za_mc_1, max_za_mc_unc_1, max_za_data_1, max_za_data_unc_1, auc_train_1, auc_train_unc_1, auc_test_1, auc_test_unc_1 = train_v2.train_bdt(config_1)
  max_za_mc_2, max_za_mc_unc_2, max_za_data_2, max_za_data_unc_2, auc_train_2, auc_train_unc_2, auc_test_2, auc_test_unc_2 = train_v2.train_bdt(config_2)
  ...
  auc_train_unc = math.sqrt((auc_train_unc_1**2) + (auc_train_unc_2**2)) / 2
  auc_test  = (auc_test_1 + auc_test_2) / 2.
  auc_test_unc = math.sqrt((auc_test_unc_1**2) + (auc_test_unc_2**2)) / 2
  ...
  scan_results[idx] = {
	...
	"auc_train" : auc_train, 
	"auc_train_unc" : auc_train_unc,
	"auc_test" : auc_test,
	"auc_test_unc" : auc_test_unc 
    }
