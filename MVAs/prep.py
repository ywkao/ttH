...
mvas = numpy.asarray([features["max1_btag_"], features["max2_btag_"], features["maxIDMVA_"], features["minIDMVA_"]])
...
mvas_validation = numpy.asarray([features_validation["max1_btag_"], features_validation["max2_btag_"], features_validation["maxIDMVA_"], features_validation["minIDMVA_"]])
...
mvas_data = numpy.asarray([features_data["max1_btag_"], features_data["max2_btag_"], features_data["maxIDMVA_"], features_data["minIDMVA_"]])
...
mvas_data_sideband = numpy.asarray([features_data_sideband["max1_btag_"], features_data_sideband["max2_btag_"], features_data_sideband["maxIDMVA_"], features_data_sideband["minIDMVA_"]])
...
mvas_data_sideband_mc = numpy.asarray([features_data_sideband_mc["max1_btag_"], features_data_sideband_mc["max2_btag_"], features_data_sideband_mc["maxIDMVA_"], features_data_sideband_mc["minIDMVA_"]])
...
dset_mvas = f_out.create_dataset("mvas", data=mvas)
...
dset_mvas_validation = f_out.create_dataset("mvas_validation", data=mvas_validation)
...
dset_mvas_data = f_out.create_dataset("mvas_data", data=mvas_data)
...
dset_mvas_data_sideband = f_out.create_dataset("mvas_data_sideband", data=mvas_data_sideband)
...
dset_mvas_data_sideband_mc = f_out.create_dataset("mvas_data_sideband_mc", data=mvas_data_sideband_mc)
